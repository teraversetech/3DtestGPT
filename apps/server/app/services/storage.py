...
class StorageClient:
    def __init__(self) -> None:
        ...
        self._offline = settings.storage_offline or os.getenv("STORAGE_OFFLINE", "0").lower() in {"1", "true", "yes"}
